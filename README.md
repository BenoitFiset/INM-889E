...
# 6 Sections pour ce projet
  ...
  + Section 3 - [Pré-Traitement des fichiers (Filtrage, Découpe, Normalisation, Corrélation) ](https://github.com/BenoitFiset/INM-889E/blob/main/BFiset_Projet_Part_03_V01.md)
    ...
    + Lien Rapide: [Bonus - Autre Normalistion Log Naturel (lien Git fonctionne mal descendre au bas de la page)](https://github.com/BenoitFiset/INM-889E/blob/main/BFiset_Projet_Part_03_V01.md#bonus)
